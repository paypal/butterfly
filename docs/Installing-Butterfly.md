...
1. Download and extract [butterfly-cli-package.zip](https://repo1.maven.org/maven2/com/paypal/butterfly/butterfly-cli-package/3.2.3/butterfly-cli-package-3.2.3.zip) file
...
Butterfly application transformation tool (version 3.2.3)
