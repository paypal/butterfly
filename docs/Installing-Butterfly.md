...
1. Download and extract [butterfly-cli-package.zip](https://repo1.maven.org/maven2/com/paypal/butterfly/butterfly-cli-package/3.0.0/butterfly-cli-package-3.0.0.zip) file
...
Butterfly application transformation tool (version 3.0.0)
