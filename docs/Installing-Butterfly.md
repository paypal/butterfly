...
1. Download and extract [butterfly-cli-package.zip](https://oss.sonatype.org/content/repositories/snapshots/com/paypal/butterfly/butterfly-cli-package/2.0.0-SNAPSHOT/butterfly-cli-package-2.0.0-20171018.041429-3.zip) file
