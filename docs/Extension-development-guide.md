...
This SPI is represented by [butterfly-extensions-api](https://javadoc.io/doc/com.paypal.butterfly/butterfly-extensions-api/latest/index.html).
...
1. [butterfly-extensions-api](https://javadoc.io/doc/com.paypal.butterfly/butterfly-extensions-api/latest/index.html): API component to be used by Butterfly extensions when providing their transformation and upgrade templates.
1. [butterfly-utilities](https://javadoc.io/doc/com.paypal.butterfly/butterfly-utilities/latest/index.html): multiple types of ready-to-use transformation utilities.
