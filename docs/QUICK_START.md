...
* Now, finally Butterfly will be used to transform the app. Run the command below. The `s` option is a shortcut to the transformation template to be applied.
 
 ```
 butterfly sample-app -s 1
 ```
