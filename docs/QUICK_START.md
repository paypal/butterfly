...
* Following the same document, install [butterfly-springboot-extension-3.2.4.jar](https://paypal.github.io/butterfly/jar/butterfly-springboot-extension-3.2.4.jar) Butterfly extension, which will be used to transform the sample application.
