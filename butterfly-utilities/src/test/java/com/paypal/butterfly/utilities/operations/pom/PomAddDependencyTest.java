...
public class PomAddDependencyTest extends TransformationUtilityTestHelper {
	...
	public void addDependencyWithVersionTest() throws IOException, XmlPullParserException {
		...
		PomAddDependency uut = new PomAddDependency("org.springframework.batch", "spring-batch-core", "3.0.7.RELEASE")
				.relative("pom.xml");
	...
	public void addDependencyWithoutVersionTest() throws IOException, XmlPullParserException {
		...
		PomAddDependency uut = new PomAddDependency("org.springframework.batch", "spring-batch-core")
				.relative("pom.xml");
	...
	public void addDependencyWithScopeTest() throws IOException, XmlPullParserException {
		...
		PomAddDependency uut = new PomAddDependency("org.springframework.batch", "spring-batch-core", "3.0.7.RELEASE")
				.relative("pom.xml").setScope("provided");
	...
	public void defaultIfPresentTest() throws IOException, XmlPullParserException {
		...
		Dependency dependencyAfterChange = getDependencyInList(getTransformedPomModel("pom.xml"), "xmlunit", "xmlunit",
				"1.7");
	...
	public void warnNotAddIfPresentTest() throws IOException, XmlPullParserException {
		...
		PomAddDependency uut = new PomAddDependency("xmlunit", "xmlunit", "1.7").relative("pom.xml")
				.warnNotAddIfPresent();
	...
	public void overwriteIfPresentTest() throws IOException, XmlPullParserException {
		...
		PomAddDependency uut = new PomAddDependency("xmlunit", "xmlunit", "1.7").relative("pom.xml")
				.overwriteIfPresent().setScope("test");
	...
	private Dependency getDependencyBeforeChange(PomAddDependency pomAddDependency)
	...
	private Dependency getDependencyAfterChange(PomAddDependency pomAddDependency)
			throws IOException, XmlPullParserException {
